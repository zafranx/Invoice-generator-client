          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/invoices-list">{props.t("invoices-list")}</Link>
                </li>
            ...
            <li>
              ...
              <Link to="/invoices-list">
                <i className="bx bx bxl-blogger"></i>
                <span>{props.t("invoices-list")}</span>
              </Link>
              ...
              {/* <Link to="/blog" className="has-arrow">
                <i className="bx bx bxl-blogger"></i>
              ...
              {/* <Link to="/jobs" className="has-arrow">
              <i className="bx bx bxl-blogger"></i>
              ...
              {/* <li>
                <Link to="/crypto">{props.t("Crypto")}</Link>
              </li>
              <li>
